...
Prefixes: `feat`, `fix`, `docs`, `chore`, `refactor`, `test`. Scope
is optional. The 2020 `fileName: ...` sandwich sample is not the
house style.
...
Build the engine with pixi or the Nix flake. The binary is `seams`
